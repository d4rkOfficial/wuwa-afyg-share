...
export default async function BuffSetsPage() {
    ...
    return (
        <div className="space-y-8 md:space-y-12">
            <div>
                <h1 className="text-2xl md:text-3xl font-bold tracking-tight">Buff 集</h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 border-t-2 border-(--card-border) pt-4">
                <a
                    href="/api/buff-sets/export"
                    className="inline-flex items-center gap-1.5 rounded-none border-2 border-(--card-border) bg-(--card) px-4 py-2 text-sm text-(--muted) transition-colors hover:text-(--fg)"
