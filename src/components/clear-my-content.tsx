    ...
    return (
        <>
            <button
                ...
                className="inline-flex items-center gap-1.5 rounded-none border border-(--danger) bg-(--danger) px-3 py-2 text-sm text-white transition-colors hover:bg-(--danger) hover:text-white"
            >
